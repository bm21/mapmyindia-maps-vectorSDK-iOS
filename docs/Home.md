...
2.  Add the following import statement: To initialize SDK you have to
...
This method is called whenever the map view finishes loading, either
...
To create custom callout view create a class inherited from
